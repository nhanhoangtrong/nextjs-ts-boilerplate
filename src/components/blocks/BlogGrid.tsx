...
function BlogGrid({ title }: Props): ReactElement {
  return (
    <section className="text-gray-700 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        {title && <h2 className="mb-6 text-xl lg:text-3xl text-center uppercase font-bold">{title}</h2>}
        <div className="flex flex-wrap -m-12">
          <div className="p-12 md:w-1/2 flex flex-col items-start">
            ...
            <p className="leading-relaxed mb-8">
              ...
              slow-carb etsy tumeric. Cray pug you probably haven't heard of them hexagon kickstarter craft beer pork
              chic.
            </p>
